...
<html lang="en">
    ...
    <body class="bg-dark">          
    <img src="mts.png" alt="" width="120" height="120">
    <img src="perpus.png" alt="" width="120" height="120" align="right">
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn btn-warning" type="submit" name="login" value="login">Login</button>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        ...
                                        <a href="https://www.instagram.com/osissmkmts/" target=”_blank”>Instagram</a>
                                &middot;
                                <a href="https://www.facebook.com/smkmtsbatam/" target="_blank">Facebook</a>
                            </div>
                                    </div>
                                </div>
                            </div>
